...
use mix_platform::texture::Texture;
...
impl DrawText {
    ...
    pub fn init(&mut self, cx: &mut Cx) {
        if self.shader_id.is_none() {
            ...
            shader.add_uniform("font_size", mix_platform::shader::ShaderUniformType::Float);
    ...
    pub fn draw(&mut self, cx: &mut Cx, draw_list_id: mix_platform::draw_list::DrawListId, rect: &Rect, font: &Font) {
